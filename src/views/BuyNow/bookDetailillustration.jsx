...
export const BookDetailIllusrationPage = () => {
    ...
    const illustrationbooks = [
        ...
        },
        {
            ...
            completedDescription: [
                "This book is the end of my SPOT ON SERIES.",
            ],
            img: "illbook5",
            trailer: "SpotOnMysteryAtTheDogRescue-Trailer",
            link: "B0BFJV9NRY",
        ...
        <LayoutTheme>
            ...
            <div className='BuyNowDetail'>
                <div className='buynowdetail_left'>
                    ...
                    {bookDetail.completedDescription && bookDetail.completedDescription.map((description, index) => {
                        return (
                ...
                <div className='buynowdetail_right'>
                    ...
                    {bookDetail.reviews && 
                        ...
                        <div className='Feedbacks'>
                            ...
                            {bookDetail.reviews && bookDetail.reviews.map((feedback, index) => {
                                return (
